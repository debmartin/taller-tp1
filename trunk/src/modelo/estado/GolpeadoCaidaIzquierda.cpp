/*
 * GolpeadoCaidaIzquierda.cpp
 *
 *  Created on: 24/5/2015
 *      Author: val
 */

#include "GolpeadoCaidaIzquierda.h"
#include "../MRUV.h"
...
GolpeadoCaidaIzquierda::GolpeadoCaidaIzquierda(Vector2f posInicial, BVH* caja) :
...
GolpeadoCaidaIzquierda::~GolpeadoCaidaIzquierda()
{
    //dtor
}

bool GolpeadoCaidaIzquierda::estaSaltando(){
    return true;
}

bool GolpeadoCaidaIzquierda::estaSaltandoDiagonalIzquierda(){
    return true;
}
