...
VueloVertical::VueloVertical(Vector2f posInicial, estado_personaje estado, BVH* caja) :
    Estado(new MRUV(posInicial, Vector2f(VELOCIDAD_DESP_HORIZONTAL, VELOCIDAD_DESP_VERTICAL), VECTOR_GRAVEDAD), estado, caja, RECIBIENDO_GOLPE) {
}

VueloVertical::VueloVertical(Vector2f posInicial, estado_personaje estado, BVH* caja, float velocidad_vertical) :
    Estado(new MRUV(posInicial, Vector2f(VELOCIDAD_DESP_HORIZONTAL, velocidad_vertical), VECTOR_GRAVEDAD), estado, caja, RECIBIENDO_GOLPE) {
}
